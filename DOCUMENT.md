...
9. [資料工具](#九資料工具-data-tools)
10. [通用功能](#十通用功能)
11. [資料層 API 整理](#十一資料層-api-整理)
12. [IndexedDB Schema 版本歷程](#十二indexeddb-schema版本歷程)
13. [JSON 匯出入格式](#十三json-匯出入格式)
14. [計算公式與邏輯說明](#十四計算公式與邏輯說明)
15. [技術注意事項](#十五技術注意事項)
...
### 11.4 Sorting 工具（`src/lib/sorting.ts`）
...
*本文件由 GitHub Copilot 依程式碼自動生成，最後更新：2026-04-29*
