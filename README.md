...
- 資產管理：新增/編輯/刪除投資標的（台股、美股、日股、基金），支援一鍵即時更新股價；提供「更新交易紀錄」依交易明細（FIFO）重新核對持有數量
- 帳戶管理：管理券商/銀行/現金帳戶，支援跨幣別帳戶轉帳
- 交易紀錄：支援買入、賣出、股息、手續費、稅費、入金、出金 7 種類型，採 FIFO 計算賣出損益；內建「更新股價」「更新交易紀錄」按鈕；新增賣出時若持有數量為 0 會阻擋（不支援「做空」記錄）
- 更新交易紀錄（對帳）：比對資產與交易的買賣筆數，依交易重建持有數量；對「有持有但無買入紀錄」的資產不會自動刪除，改由使用者逐筆確認
